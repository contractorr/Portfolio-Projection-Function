...
# topup = 4000
# t_years = 3
# results = invest(starting_amount=starting
...
# plot_upper_lower_bound_returns(yrs,exp,upp,low)

# JKB = [8.88, -14.31, 22.37, 81.07, 148.05, -12.15, 45.55, 36.80]
# print('JKB: Average - ', sum(JKB)/len(JKB), ' Active - ', len(JKB))
# # 39.5, 8
# GT = [224.89, 53.26, -52.24, 80.02, -23.38, 48.7, 43.04]
# print('GT: Average - ', sum(GT)/len(GT), ' Active - ', len(GT))
# # 53.5, 7
# RMS = [-15.44, 41.47,60.17]
# print('RMS: Average - ', sum(RMS)/len(RMS), ' Active - ', len(RMS))
# # 28.7, 3
# EB = [21.72, 540.91, -3.9, 19.34,49.81]
# print('EB: Average - ', sum(EB)/len(EB), ' Active - ', len(EB))
# # 125.6, 5
# OVERALL = JKB + GT + RMS + EB
# print('OVERALL: Average - ', sum(OVERALL)/len(OVERALL), ' Active - ', len(OVERALL))
# # 61.1, 23 